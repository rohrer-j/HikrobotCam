...
sys.path.append('./generated')  # Ensure the generated files are in the path 
import hikrobot_pb2
import hikrobot_pb2_grpc
...
class HikRobotCameraServicer(hikrobot_pb2_grpc.HikRobotCameraServiceServicer):
    def __init__(self):
    ...
    def Connect(self, request, context):
        try:
            ...
            return hikrobot_pb2.ConnectResponse(message="Camera connected successfully")
    ...
    def GetImage(self, request, context):
        try:
            ...
            return hikrobot_pb2.GetImageResponse(image_data=image_data, width=img.width, height=img.height)
        except HikRobotCameraException as e:
    ...
    def SetExposure(self, request, context):
        try:
            ...
            return hikrobot_pb2.SetExposureResponse()
        except HikRobotCameraException as e:
            raise Internal(str(e))
    ...
    def SetGain(self, request, context):
        try:
            ...
            return hikrobot_pb2.SetGainResponse()
        except HikRobotCameraException as e:
            raise Internal(str(e))
    ...
    def SetFrameRate(self, request, context):
        try:
            ...
            return hikrobot_pb2.SetFrameRateResponse()
        except HikRobotCameraException as e:
            raise Internal(str(e))
...
def serve():
    ...
    hikrobot_pb2_grpc.add_HikRobotCameraServiceServicer_to_server(HikRobotCameraServicer(), server)
